    ...
    function se(e, t, n, r) {
      ...
      if (!r && (T(t), (t = t || C), E)) {
        ...
        if (
          ...
          if (((l = e), (c = t), 1 === f && (V.test(e) || X.test(e)))) {
            for (
              ((c = (ne.test(e) && ge(t.parentNode)) || t) === t && p.scope) ||
                ((a = t.getAttribute("id"))
                  ? (a = a.replace(ie, oe))
  ...
  E.ajaxSetup({
    ...
    (E.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === s && (e.style.position = "relative"),
          ...
          null != (t = x(t) ? t.call(e, n, E.extend({}, o)) : t).top &&
            (l.top = t.top - o.top + i),
    ...
    E.each(["top", "left"], function (e, n) {
      E.cssHooks[n] = Xe(v.pixelPosition, function (e, t) {
        if (t)
          return (t = Ue(e, n)), $e.test(t) ? E(e).position()[n] + "px" : t;
      });
    }),
